...
check_include_files(linux/can.h HAVE_LINUX_CAN_H)
check_include_files(linux/can/raw.h HAVE_LINUX_CAN_RAW_H)
...
check_include_files(sys/kern_control.h HAVE_SYS_KERN_CONTROL_H)
...
check_symbol_exists(clock_getres   "${CFG_HEADERS}" HAVE_CLOCK_GETRES)
check_symbol_exists(clock_gettime  "${CFG_HEADERS}" HAVE_CLOCK_GETTIME)
...
check_symbol_exists(log2           "${CFG_HEADERS}" HAVE_LOG2)
...
set(HAVE_INT32_T ${SIZEOF_INT32})
check_type_size(int64_t SIZEOF_INT64)
set(HAVE_INT64_T ${SIZEOF_INT64})
check_type_size(uint32_t SIZEOF_UINT32)
set(HAVE_UINT32_T ${SIZEOF_UINT32})
check_type_size(uint64_t SIZEOF_UINT64)
set(HAVE_UINT64_T ${SIZEOF_UINT64})
...
set(FLAGS "-O2")
set(DEFS "-D_FORTIFY_SOURCE=2")

check_c_compiler_flag("-O2" USE_OPTIMIZE_L2_FLAG)
if(NOT USE_OPTIMIZE_L2_FLAG)
  set(FLAGS "")
  set(DEFS "")
endif()

# no status option for cross-compile, unlike AC_RUN_IFELSE

# from python 3.3.1 configure.ac:
#
# _FORTIFY_SOURCE wrappers for memmove and bcopy are incorrect:
# http://sourceware.org/ml/libc-alpha/2010-12/msg00009.html

try_run(FAILED_GLIBC_MEMMOVE_TEST COMPILE_RESULT
  ${CMAKE_CURRENT_BINARY_DIR}/CMakeTmp
  ${Python_SOURCE_DIR}/CMake/Test_FORTIFY_SOURCE_wrappers.c
  CMAKE_FLAGS ${FLAGS}
  COMPILE_DEFINITIONS ${DEFS}
  RUN_OUTPUT_VARIABLE RUN_OUTPUT
)
if(${FAILED_GLIBC_MEMMOVE_TEST} EQUAL 1)
...
try_run(FAILED_IPA_PURE_CONST_TEST COMPILE_RESULT
  ${CMAKE_CURRENT_BINARY_DIR}/CMakeTmp
  ${Python_SOURCE_DIR}/CMake/Test_HAVE_IPA_PURE_CONST_BUG.c
  CMAKE_FLAGS ${FLAGS}
  COMPILE_DEFINITIONS ${DEFS}
  RUN_OUTPUT_VARIABLE RUN_OUTPUT
)
if(${FAILED_IPA_PURE_CONST_TEST} EQUAL 1)
  set(HAVE_IPA_PURE_CONST_BUG 1)
endif()

# from python 3.3.1 configure.ac:

try_run(PASSED_HAVE_PROTOTYPES_TEST COMPILE_RESULT
  ${CMAKE_CURRENT_BINARY_DIR}/CMakeTmp
  ${Python_SOURCE_DIR}/CMake/Test_HAVE_PROTOTYPES.c
  CMAKE_FLAGS ${FLAGS}
  COMPILE_DEFINITIONS ${DEFS}
  RUN_OUTPUT_VARIABLE RUN_OUTPUT
)
if(${PASSED_HAVE_PROTOTYPES_TEST} EQUAL 0)
